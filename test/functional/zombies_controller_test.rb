...
class ZombiesControllerTest < ActionController::TestCase
  ...
  test "should create zombie" do
    assert_difference('Zombie.count') do
      post :create, zombie: { message: @zombie.message, name: @zombie.name, secret: @zombie.secret, show: @zombie.show }
    end
  ...
  test "should update zombie" do
    put :update, id: @zombie, zombie: { message: @zombie.message, name: @zombie.name, secret: @zombie.secret, show: @zombie.show }
    assert_redirected_to zombie_path(assigns(:zombie))
  end
